...
export WANDB_NAME='research-v0.1'
...
pretrained_model=./models/Qwen1.5-4B-Chat-Research
tokenizer_name_or_path=${pretrained_model}
dataset_config_file=./config/research/ta-research-v0.1.json
data_cache=.cache
per_device_train_batch_size=1
gradient_accumulation_steps=256
block_size=4096
output_dir=outputs/tamil-pretraining-research-v0.1
